...
Este curso es ideal para cualquier persona curiosa sobre el impacto social de la IA, incluyendo:
...
Este proyecto está bajo la licencia [MIT License](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.es). 
Consulta el archivo [`LICENCIA`](./LICENCIA) para más detalles.
